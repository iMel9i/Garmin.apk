# Install APK Script for GoogleMaps HUD
# This script installs the already built APK on a connected Android device
...
Write-Host "=== GoogleMaps HUD - Install APK ===" -ForegroundColor Cyan
Write-Host ""
...
if (!(Test-Path $apkPath)) {
    ...
    Write-Host "Please build the APK first using: .\gradlew assembleDebug" -ForegroundColor Yellow
    exit 1
}
